...
class AddValidatorPage(QWidget):
    ui_events : UIEvents
    ...
    def create_widgets(self):
        ...
        self.titleLabel = QLabel("Add Validator Node", self)
        self.titleLabel.setAlignment(Qt.AlignCenter)

        self.backButton = QPushButton("Back" , self)
        self.backButton.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)

        self.nodeLabel = QLabel("Node Id" , self)
        self.nodeEdit = QLineEdit(self)
    ...
    def submit_button_clicked(self):
        nodeId = self.nodeEdit.text().strip()
        self.ui_events.add_validator_pressed.emit(nodeId)
        QMessageBox.information(self , "Submitted" , "New Validator Submitted!")
    ...
    def format(self):
        ...
        self.form_layout.addWidget(self.nodeLabel)
        self.form_layout.addWidget(self.nodeEdit)
        ...
        self.nodeLabel.setMaximumWidth(400)
        self.nodeEdit.setMaximumWidth(400)
    ...
    def resizeEvent(self, event):
        ...
        self.nodeLabel.setFont(QFont("Arial", input_label_size))

        input_text_size = int(min(int(self.width() * 0.025), MAX_FONT_SIZE // 1.5))  # Text inside inputs
        self.nodeEdit.setFont(QFont("Arial", input_text_size))
